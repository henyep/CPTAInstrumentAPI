 ...
 * @author Danny
 */
public interface CPTAInstrumentDatabaseConstants
{
    /*
1 - CUSIP
2 - SEDOL
...
I - ISDA/FpML    
    */
    ...
    public static final String INSTRUMENT_ID_FIELD_NAME = "Identifier";
    public static final String INSTRUMENT_ID_SOURCE_FIELD_NAME = "IdentifierType";
